...
4. **vault 컨텍스트 로딩** (AGENTS.md 규칙 0~1):
  ...
  members: [
    {
      ...
      prompt: """너는 hola-climbing-ai 워커의 architect다.
        ...
        에이전트 정의: .Codex/agents/architect.md
    ...
    },
    {
      ...
      prompt: """너는 vision-engineer다. MediaPipe Pose + 휴리스틱 규칙으로 클라이밍 기술
        ...
        에이전트 정의: .Codex/agents/vision-engineer.md
    ...
    },
    {
      ...
      prompt: """너는 pipeline-engineer다. GCS Signed URL 다운로드, OpenCV 프레임 추출,
        ...
        에이전트 정의: .Codex/agents/pipeline-engineer.md
    ...
    },
    {
      ...
      prompt: """너는 integration-engineer다. Spring 계약(ApiResponse/ErrorCode/snake_case JSON/
        ...
        에이전트 정의: .Codex/agents/integration-engineer.md
    ...
    },
    {
      ...
      prompt: """너는 qa-engineer다. 각 모듈 완성 직후 점진적으로 검증한다.
        ...
        스킬: ai-worker-qa
        에이전트 정의: .Codex/agents/qa-engineer.md
...
3. AGENTS.md (또는 `.Codex/HARNESS.md`) 변경 이력 업데이트
...
- [ ] `.Codex/agents/` 5개 (architect, vision-engineer, pipeline-engineer, integration-engineer, qa-engineer)
- [ ] `.Codex/skills/` 6개 (본 오케스트레이터 + 5개 전문 스킬)
- [ ] `_workspace/` 산출물 보존 (00_input ~ 05_qa)
- [ ] 실제 코드: `app/`, `tests/`, `pyproject.toml`, `.env.example`, `Dockerfile`, `docker-compose.yml`, `README.md`
- [ ] 변경 이력 기록 (`.Codex/HARNESS.md`)

## 참고

- 하네스 메타 스킬: `~/.Codex/skills/harness/SKILL.md`
- 에이전트 패턴: `~/.Codex/skills/harness/references/agent-design-patterns.md`
- 오케스트레이터 템플릿: `~/.Codex/skills/harness/references/orchestrator-template.md`
